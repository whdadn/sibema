                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-8 mt-30">
                        <h4 class="font-20 weight-500 mb-30 text-capitalize">
                            Selamat Datang
                            <div class="weight-600 font-30 text-blue">Panitia Keuangan</div>
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-8">
                    <div class="text-center mb-30">
                        <h4>Status Bebas Masalah Registrasi</h4>
                    </div>
                        ...
                        <tbody>
                            @foreach ($mahasiswa as $mhs)
                                <tr class="clickable-row" data-id="{{ $mhs->id_mahasiswa }}">
                                    ...
                                    <td><a
                                            href="/dashboardPanitiaKeuangan/statusRegistrasi/detail{{ $mhs->keuangan->pluck('id_keuangan')->implode(', ') }}"><i
                                    ...
                                    <td>
                                        @if ($mhs->first() != null)
                                            <a
                                                href="/dashboardPanitiaKeuangan/ubahStatusRegistrasi{{ $mhs->keuangan->pluck('id_keuangan')->implode(', ') }}"><i
